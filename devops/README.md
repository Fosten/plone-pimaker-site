...
```
DEPLOY_ENV=prod
DEPLOY_HOST=pimaker.org
DEPLOY_PORT=22
DEPLOY_USER=plone
DOCKER_CONFIG=.docker
STACK_NAME=pimaker-org
```
...
You need either a Ubuntu or Debian based system for pimaker.org, enable SSH, and install a supported version of Python 3 on that system.
...
Deploy the stack defined in `devops/stacks/pimaker.org.yml` to the remote server with:
